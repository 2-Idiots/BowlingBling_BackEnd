...
public class LessonCommentController {
    ...
    @GetMapping
    public ResponseEntity<Page<CommentResponseDto>> getComments(@PathVariable Long lessonId, @RequestParam(defaultValue = "0") int page) {
        Page<CommentResponseDto> comments = lessonCommentService.getComments(lessonId, PageRequest.of(page, 10));
